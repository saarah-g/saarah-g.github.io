...
The beginning of the video shows the PATBLC tracking the object from Quadrant 1 to Quadrant 2 (explained in the IK section). Next, the it shows successful data transmission via laser. Finally, it shows me manually controlling the system with my mouse.
