...
## Project Overview
The goal of this project is to deploy a remote-controlled quadruped platform on which ORB-SLAM2 can be performed. As the first portion of this two-part project, I built a Pybullet environment using the open-source Spot Micro CAD models for a fairly accessible (< $1000) robot. Then, I deployed a 12-point Bezier gait with proprioceptive feedback for phase reset, and used this as a baseline for Reinforcement Learning tasks on various terrain environments. Feel free to check out the package on [Github](https://github.com/moribots/spot_mini_mini).
...
<div class="gallery" data-columns="1">
	<img src="/images/Projects/spot-mini-mini/io.jpg" style="width: 100%">
	<img src="/images/Projects/spot-mini-mini/thf.jpg" style="width: 100%">
</div>

Here's a gif of the body IK in action:

<div class="gallery" data-columns="1">
	<img src="/images/Projects/spot-mini-mini/spot_rpy.gif" style="width: 100%">
</div>
...
| Bezier Point |      x        |     reasoning                        | z (y in paper)  |     reasoning                        |
|--------------|---------------|--------------------------------------|-----------------|--------------------------------------|
| p0           |    -StepLen   | Half of Stride Length                |       0.0       | Zero Lift Velocity wrt Hip           |
| p1           | -1.4 StepLen  | Zero Lift Velocity wrt Hip           |       0.0       | Zero Lift Velocity wrt Hip           |
| p2           | -1.5 StepLen  | Direction Change Post Follow-Through | 0.9 Step Height | Direction Change Post Follow-Through |
| p3           | -1.5 StepLen  | Direction Change Post Follow-Through | 0.9 Step Height | Direction Change Post Follow-Through |
| p4           | -1.5 StepLen  | Direction Change Post Follow-Through | 0.9 Step Height | Direction Change Post Follow-Through |
| p5           |     0.0       | Acceleration Change for Protraction  | 0.9 Step Height | Direction Change for Protraction     |
| p6           |     0.0       | Acceleration Change for Protraction  | 0.9 Step Height | Direction Change for Protraction     |
| p7           |     0.0       | Acceleration Change for Protraction  | 1.1 Step Height | Maximum Clearance Height Mid-Traj    |
| p8           |  1.5 StepLen  | Direction Change for Retraction      | 1.1 Step Height | Smooth Protraction to Retraction     |
| p9           |  1.5 StepLen  | Direction Change for Retraction      | 1.1 Step Height | Smooth Protraction to Retraction     |
| p10          |  1.4 StepLen  | Retraction Velocity = p11 - p10      |       0.0       | Zero Touchdown Velocity wrt Hip      |
| p11          |    StepLen    | Retraction Velocity = p11 - p10      |       0.0       | Zero Touchdown Velocity wrt Hip      |

<div class="gallery" data-columns="1">
	<img src="/images/Projects/spot-mini-mini/bezier.jpg" style="width: 100%">
</div>
...
<div class="gallery" data-columns="1">
	<img src="/images/Projects/spot-mini-mini/yaw_overview.jpg" style="width: 100%">
	<img src="/images/Projects/spot-mini-mini/yaw_mod.jpg" style="width: 100%">
</div>
